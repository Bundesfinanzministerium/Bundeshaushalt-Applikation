...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:bmf_budget/Resources/Private/Language/locallang_db.xlf:tx_bmfbudget_domain_model_groupe',
        'label' => 'address',
        'label_alt' => 'title',
        'label_alt_force' => 1,
        'tstamp' => 'tstamp',
        ...
        'iconfile' => \TYPO3\CMS\Core\Utility\GeneralUtility::getFileAbsFileName(
            'EXT:bmf_budget/Resources/Public/Icons/tx_bmfbudget_domain_model_groupe.gif'
        )
    ],
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, budget, groupe, address, title,
		actual_income, actual_expenses, target_income, target_expenses, info_image, info_text, info_link, groups, titles',
    ],
    'types' => [
        '1' => [
            'showitem' => '
				budget, groupe, address, title, actual_income, actual_expenses, target_income, target_expenses,
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_bmfbudget_domain_model_groupe.pid=###CURRENT_PID### ' .
                    'AND tx_bmfbudget_domain_model_groupe.sys_language_uid IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
        ...
        'groupe' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_bmfbudget_domain_model_groupe.pid = ###PAGE_TSCONFIG_ID### ' .
                    'AND tx_bmfbudget_domain_model_groupe.uid <> ###THIS_UID### ' .
