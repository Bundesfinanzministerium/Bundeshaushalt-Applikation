...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:bmf_budget/Resources/Private/Language/locallang_db.xlf:tx_bmfbudget_domain_model_supplementarytitle',
        'label' => 'supplementarybudget',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        'dividers2tabs' => true,
        ...
        'searchFields' => 'info_text,',
        'iconfile' => \TYPO3\CMS\Core\Utility\GeneralUtility::getFileAbsFileName(
            'EXT:bmf_budget/Resources/Public/Icons/tx_bmfbudget_domain_model_supplementarytitle.gif'
        )
    ],
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, title, supplementarybudget,
		actual_income, actual_expenses, target_income, target_expenses, actual_page, target_page, info_image, info_text, info_link',
    ],
    'types' => [
        '1' => [
            'showitem' => '
				supplementarybudget, title, actual_income, actual_expenses, target_income, target_expenses, actual_page, target_page,
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_bmfbudget_domain_model_supplementarytitle.pid=###CURRENT_PID### AND ' .
                    'tx_bmfbudget_domain_model_supplementarytitle.sys_language_uid IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
        ...
        'title' => [
            'label' => 'LLL:EXT:bmf_budget/Resources/Private/Language/locallang_db.xlf:corresponding_title',
            'config' => [
                'type' => 'select',
                'items' => [
                ...
                'foreign_table_where' => 'AND tx_bmfbudget_domain_model_title.pid = ###PAGE_TSCONFIG_ID### ',
                'minitems' => 0,
                'maxitems' => 1,
            ],
        ],
        'supplementarybudget' => [
            'label' => 'LLL:EXT:bmf_budget/Resources/Private/Language/locallang_db.xlf:corresponding_supplementarybudget',
            'config' => [
                'type' => 'select',
                'items' => [
                    ['LLL:EXT:bmf_budget/Resources/Private/Language/locallang_db.xlf:please_choose', 0],
                ...
                'foreign_table_where' => 'AND tx_bmfbudget_domain_model_supplementarybudget.pid = ###PAGE_TSCONFIG_ID### ',
                'minitems' => 0,
                'maxitems' => 1,
            ],
        ],
