...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:bmf_budget/Resources/Private/Language/locallang_db.xlf:tx_bmfbudget_domain_model_functione',
        'label' => 'address',
        'label_alt' => 'title',
        'label_alt_force' => 1,
        'tstamp' => 'tstamp',
        ...
        'iconfile' => \TYPO3\CMS\Core\Utility\GeneralUtility::getFileAbsFileName(
            'EXT:bmf_budget/Resources/Public/Icons/tx_bmfbudget_domain_model_functione.gif'
        )
    ],
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, budget, functione, address, title,
		 actual_income, actual_expenses, target_income, target_expenses, info_image, info_text, info_link, functions, titles',
    ],
    'types' => [
        '1' => [
            'showitem' => '
				budget, functione, address, title, actual_income, actual_expenses, target_income, target_expenses,
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_bmfbudget_domain_model_functione.pid=###CURRENT_PID### ' .
                    'AND tx_bmfbudget_domain_model_functione.sys_language_uid IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
        ...
        'functions' => [
            ...
            'displayCond' => 'USER:PPKOELN\\BmfBudget\\Domain\\Validator\\Tce\\DisplayCondition->showIfLevel:lower:3',
            'config' => [
                'type' => 'inline',
                'foreign_table' => 'tx_bmfbudget_domain_model_functione',
                'foreign_field' => 'functione',
                'maxitems' => 9999,
                'appearance' => [
                    'collapseAll' => 1,
        ...
        'titles' => [
            'exclude' => 0,
            'label' => 'LLL:EXT:bmf_budget/Resources/Private/Language/locallang_db.xlf:title',
            'displayCond' => 'USER:PPKOELN\\BmfBudget\\Domain\\Validator\\Tce\\DisplayCondition->showIfLevel:equal:3',
            'config' => [
                'type' => 'inline',
        ...
        'functione' => [
            ...
            'displayCond' => 'USER:PPKOELN\\BmfBudget\\Domain\\Validator\\Tce\\DisplayCondition->showIfLevel:greater:1',
            'config' => [
                'type' => 'select',
                'items' => [
                ...
                'foreign_table_where' => 'AND tx_bmfbudget_domain_model_functione.pid = ###PAGE_TSCONFIG_ID### ' .
                    'AND tx_bmfbudget_domain_model_functione.uid <> ###THIS_UID### ' .
        ...
        'budget' => [
            ...
            'displayCond' => 'USER:PPKOELN\\BmfBudget\\Domain\\Validator\\Tce\\DisplayCondition->showIfLevel:equal:1',
            'config' => [
                'type' => 'select',
                'items' => [
                    ['LLL:EXT:bmf_budget/Resources/Private/Language/locallang_db.xlf:please_choose', 0],
